...
public class VentanaMostrarVisitantes  extends JFrame{

	private DefaultTableModel tabla = new DefaultTableModel();
	private JTable tablaVisitantes;
	private static VentanaMostrarVisitantes instancia;
	private String titulos[] = {"Nombre","Apellido","Telefono","Direccion","Sexo"};
	
	public static synchronized VentanaMostrarVisitantes getInstancia(){
		
		if(instancia == null){
			instancia = new VentanaMostrarVisitantes();
		}
		return instancia;
	}
	
	private VentanaMostrarVisitantes(){
		...
		tablaVisitantes.setPreferredScrollableViewportSize(new Dimension(500,300));
